...
body {
  ...
  <body>
        ...
        <div class="row wrapper fadeInDown">
                ...
                <div class="col-sm-4 jumbotron" style="padding:2rem;">
                <!-- Tabs Titles -->
                     ...
                     <div class="form-row">
                     	...
                     	<div class="form-group col-sm-3">
	                         <div class="custom-control custom-radio custom-control-inline">
	  							...
	  							<label class="custom-control-label" for="customCheck2">Lamp</label>
							</div>
						</div>
                     	<div class="form-group col-sm-3">
	                         <div class="custom-control custom-radio custom-control-inline">
	  							<input type="radio" class="custom-control-input" id="customCheck3" name="domain">
	  							<label class="custom-control-label" for="customCheck3">CMS</label>
							</div>
						</div>
                     	<div class="form-group col-sm-3">
	                         <div class="custom-control custom-radio custom-control-inline">
	  							<input type="radio" class="custom-control-input" id="customCheck4" name="domain">
	  							<label class="custom-control-label" for="customCheck4">LD Bank</label>
							</div>
						</div>
                     </div>
                     <div class="form-row">
                     	<div class="form-group col-sm-3">
	                         <div class="custom-control custom-radio custom-control-inline">
	  							<input type="radio" class="custom-control-input" id="customCheck4" name="domain">
	  							<label class="custom-control-label" for="customCheck4">Urban</label>
							</div>
						</div>
                     	<div class="form-group col-sm-3">
	                         <div class="custom-control custom-radio custom-control-inline">
	  							<input type="radio" class="custom-control-input" id="customCheck4" name="domain">
	  							<label class="custom-control-label" for="customCheck4">Stores</label>
							</div>
						</div>
                     	<div class="form-group col-sm-4">
	                         <div class="custom-control custom-radio custom-control-inline">
	  							<input type="radio" class="custom-control-input" id="customCheck4" name="domain">
	  							<label class="custom-control-label" for="customCheck4">Emp Society</label>
							</div>
						</div>
                     </div>
