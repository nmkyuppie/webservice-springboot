...
<body>
    ...
    <div class="row justify-content-end" style="margin: 15px -15px;">
    	<div class="col offset-md-6">
    		<form action="/member/add#active" method="GET">
				...
				<table class="table table-sm">
					...
					<tbody>
						<c:forEach items="${memberList}" var="m">
							<tr>
								<td>
									<form action="/member/edit#active" method="POST">
								...
								<td>
									<form action="/member/history#active" method="POST">
										<input type="hidden" value="${m.id}" name="id">
								...
								<td>
									<form action="/member/delete#active" method="POST">
										<input type="hidden" value="${m.id}" name="id">
