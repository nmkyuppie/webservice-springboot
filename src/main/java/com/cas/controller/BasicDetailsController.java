...
public class BasicDetailsController {
	...
	@Autowired
	SharesHistoryRepository sharesHistoryRepository;
	@Autowired
	SocietyEmployeeRepository societyEmployeeRepository;
	@Autowired
	SocietyEmployeeHistoryRepository societyEmployeeHistoryRepository;
	@Autowired
	RetirementDetailsRepository retirementDetailsRepository;
	@Autowired
	RetirementDetailsHistoryRepository retirementDetailsHistoryRepository;
	@Autowired
	AuditDetailsRepository auditDetailsRepository;
	@Autowired
	AuditDetailsHistoryRepository auditDetailsHistoryRepository;
	@Autowired
	BoardDetailsRepository boardDetailsRepository;
	@Autowired
	BoardDetailsHistoryRepository boardDetailsHistoryRepository;
	@Autowired
	PromotionDetailsRepository promotionDetailsRepository;
	@Autowired
	PromotionDetailsHistoryRepository promotionDetailsHistoryRepository;
	@Autowired
	PetitionRepository petitionRepository;
	@Autowired
	PetitionHistoryRepository petitionHistoryRepository;
	@Autowired
	DeputationRepository deputationRepository;
	@Autowired
	SpecialReportRepository specialReportRepository;
	@Autowired
	SpecialReportHistoryRepository specialReportHistoryRepository;
	@Autowired
	DeputationHistoryRepository deputationHistoryRepository;
	@Autowired
	BonusDetailsRepository bonusDetailsRepository;
	@Autowired
	BonusDetailsHistoryRepository bonusDetailsHistoryRepository;
	@Autowired
	StockVerificationRepository stockVerificationRepository;
	@Autowired
	StockVerificationHistoryRepository stockVerificationHistoryRepository;
	@Autowired
	...
	@Autowired
	EnquiryHistoryRepository enquiryHistoryRepository;
	@Autowired
	...
	public ModelAndView getAddMemberPage(@ModelAttribute("member") Member member, BindingResult result,
			ModelMap model) {
	...
	public String saveMember(@SessionAttribute("userDetails") UserDetails userDetails,
			@SessionAttribute("societyInfo") Society society, @ModelAttribute("member") Member member,
	...
	@Transactional(propagation = Propagation.REQUIRED, isolation = Isolation.READ_UNCOMMITTED)
	public ModelAndView deleteMember(@SessionAttribute("userDetails") UserDetails userDetails,
			@SessionAttribute("societyInfo") Society society, @ModelAttribute("id") Integer memberId,
			BindingResult result, ModelMap model) {
		memberHistoryRepository
				.save(MemberHistory.setUpObject(memberRepository.findById(memberId).get(), userDetails.getLoginId()));
	...
	public ModelAndView getEditMemberPage(@ModelAttribute("id") Integer memberId, BindingResult result,
			ModelMap model) {
	...
	public ModelAndView getAddSharesPage(@ModelAttribute("shares") Shares shares, BindingResult result,
			ModelMap model) {
	...
	@Transactional(propagation = Propagation.REQUIRED, isolation = Isolation.READ_UNCOMMITTED)
	public String saveShares(@SessionAttribute("userDetails") UserDetails userDetails,
			@SessionAttribute("societyInfo") Society society, @ModelAttribute("shares") Shares shares,
			BindingResult result, ModelMap model) {
	...
	@Transactional(propagation = Propagation.REQUIRED, isolation = Isolation.READ_UNCOMMITTED)
	public ModelAndView deleteShares(@SessionAttribute("userDetails") UserDetails userDetails,
			@SessionAttribute("societyInfo") Society society, @ModelAttribute("id") Integer sharesId,
			BindingResult result, ModelMap model) {
		sharesHistoryRepository
				.save(SharesHistory.setUpObject(sharesRepository.findById(sharesId).get(), userDetails.getLoginId()));
	...
	public ModelAndView getEditSharesPage(@ModelAttribute("id") Integer sharesId, BindingResult result,
			ModelMap model) {
	...
	@Transactional(propagation = Propagation.REQUIRED, isolation = Isolation.READ_UNCOMMITTED)
	public String saveSocietyEmployee(@SessionAttribute("userDetails") UserDetails userDetails,
			@SessionAttribute("societyInfo") Society society,
			@ModelAttribute("societyEmployee") SocietyEmployee societyEmployee, BindingResult result, ModelMap model) {
		societyEmployee.setSocietyId(society.getId());
		societyEmployee = societyEmployeeRepository.save(societyEmployee);
		societyEmployeeHistoryRepository
				.save(SocietyEmployeeHistory.setUpObject(societyEmployee, userDetails.getLoginId()));
	...
	@Transactional(propagation = Propagation.REQUIRED, isolation = Isolation.READ_UNCOMMITTED)
	public ModelAndView deleteSocietyEmployee(@SessionAttribute("userDetails") UserDetails userDetails,
			@SessionAttribute("societyInfo") Society society, @ModelAttribute("id") Integer societyEmployeeId,
			BindingResult result, ModelMap model) {
		societyEmployeeHistoryRepository.save(SocietyEmployeeHistory
				.setUpObject(societyEmployeeRepository.findById(societyEmployeeId).get(), userDetails.getLoginId()));
	...
	public ModelAndView getEditSocietyEmployeePage(@ModelAttribute("id") Integer societyEmployeeId,
			BindingResult result, ModelMap model) {
	...
	public ModelAndView getSocietyEmployeeHistoryPage(@ModelAttribute("id") Integer societyEmployeeId) {
		Map<String, Object> model = new HashMap<>();
		List<SocietyEmployeeHistory> societyEmployeeHistoryList = societyEmployeeHistoryRepository
				.findBySocietyEmployeeIdOrderByUpdatedOnDesc(societyEmployeeId);
	...
	public ModelAndView getAddRetirementDetailsPage(
			@ModelAttribute("retirementDetails") RetirementDetails retirementDetails, BindingResult result,
			ModelMap model) {
	...
	@Transactional(propagation = Propagation.REQUIRED, isolation = Isolation.READ_UNCOMMITTED)
	public String saveRetirementDetails(@SessionAttribute("userDetails") UserDetails userDetails,
			@SessionAttribute("societyInfo") Society society,
			@ModelAttribute("retirementDetails") RetirementDetails retirementDetails, BindingResult result,
			ModelMap model) {
		retirementDetails.setSocietyId(society.getId());
		retirementDetails = retirementDetailsRepository.save(retirementDetails);
		retirementDetailsHistoryRepository
				.save(RetirementDetailsHistory.setUpObject(retirementDetails, userDetails.getLoginId()));
	...
	@Transactional(propagation = Propagation.REQUIRED, isolation = Isolation.READ_UNCOMMITTED)
	public ModelAndView deleteRetirementDetails(@SessionAttribute("userDetails") UserDetails userDetails,
			@SessionAttribute("societyInfo") Society society, @ModelAttribute("id") Integer retirementDetailsId,
			BindingResult result, ModelMap model) {
		retirementDetailsHistoryRepository.save(RetirementDetailsHistory.setUpObject(
				retirementDetailsRepository.findById(retirementDetailsId).get(), userDetails.getLoginId()));
	...
	public ModelAndView getEditRetirementDetailsPage(@ModelAttribute("id") Integer retirementDetailsId,
			BindingResult result, ModelMap model) {
	...
	public ModelAndView getRetirementDetailsHistoryPage(@ModelAttribute("id") Integer retirementDetailsId) {
		Map<String, Object> model = new HashMap<>();
		List<RetirementDetailsHistory> retirementDetailsHistoryList = retirementDetailsHistoryRepository
				.findByRetirementDetailsIdOrderByUpdatedOnDesc(retirementDetailsId);
	...
	public ModelAndView getAddAuditDetailsPage(@ModelAttribute("auditDetails") AuditDetails auditDetails,
			BindingResult result, ModelMap model) {
	...
	@Transactional(propagation = Propagation.REQUIRED, isolation = Isolation.READ_UNCOMMITTED)
	public String saveAuditDetails(@SessionAttribute("userDetails") UserDetails userDetails,
			@SessionAttribute("societyInfo") Society society, @ModelAttribute("auditDetails") AuditDetails auditDetails,
			BindingResult result, ModelMap model) {
	...
	@Transactional(propagation = Propagation.REQUIRED, isolation = Isolation.READ_UNCOMMITTED)
	public ModelAndView deleteAuditDetails(@SessionAttribute("userDetails") UserDetails userDetails,
			@SessionAttribute("societyInfo") Society society, @ModelAttribute("id") Integer auditDetailsId,
			BindingResult result, ModelMap model) {
		auditDetailsHistoryRepository.save(AuditDetailsHistory
				.setUpObject(auditDetailsRepository.findById(auditDetailsId).get(), userDetails.getLoginId()));
	...
	public ModelAndView getEditAuditDetailsPage(@ModelAttribute("id") Integer auditDetailsId, BindingResult result,
			ModelMap model) {
	...
	public ModelAndView getAuditDetailsHistoryPage(@ModelAttribute("id") Integer auditDetailsId) {
		Map<String, Object> model = new HashMap<>();
		List<AuditDetailsHistory> auditDetailsHistoryList = auditDetailsHistoryRepository
				.findByAuditDetailsIdOrderByUpdatedOnDesc(auditDetailsId);
	...
	public ModelAndView getAddBoardDetailsPage(@ModelAttribute("boardDetails") BoardDetails boardDetails,
			BindingResult result, ModelMap model) {
	...
	@Transactional(propagation = Propagation.REQUIRED, isolation = Isolation.READ_UNCOMMITTED)
	public String saveAuditBoardDetails(@SessionAttribute("userDetails") UserDetails userDetails,
			@SessionAttribute("societyInfo") Society society, @ModelAttribute("boardDetails") BoardDetails boardDetails,
			BindingResult result, ModelMap model) {
	...
	@Transactional(propagation = Propagation.REQUIRED, isolation = Isolation.READ_UNCOMMITTED)
	public ModelAndView deleteBoardDetails(@SessionAttribute("userDetails") UserDetails userDetails,
			@SessionAttribute("societyInfo") Society society, @ModelAttribute("id") Integer boardDetailsId,
			BindingResult result, ModelMap model) {
		boardDetailsHistoryRepository.save(BoardDetailsHistory
				.setUpObject(boardDetailsRepository.findById(boardDetailsId).get(), userDetails.getLoginId()));
	...
	public ModelAndView getEditBoardDetailsPage(@ModelAttribute("id") Integer boardDetailsId, BindingResult result,
			ModelMap model) {
	...
	public ModelAndView getBoardDetailsHistoryPage(@ModelAttribute("id") Integer boardDetailsId) {
		Map<String, Object> model = new HashMap<>();
		List<BoardDetailsHistory> boardDetailsHistoryList = boardDetailsHistoryRepository
				.findByBoardDetailsIdOrderByUpdatedOnDesc(boardDetailsId);
	...
	public ModelAndView getAddPromotionDetailsPage(
			@ModelAttribute("promotionDetails") PromotionDetails promotionDetails, BindingResult result,
			ModelMap model) {
	...
	@Transactional(propagation = Propagation.REQUIRED, isolation = Isolation.READ_UNCOMMITTED)
	public String savePromotionDetails(@SessionAttribute("userDetails") UserDetails userDetails,
			@SessionAttribute("societyInfo") Society society,
			@ModelAttribute("promotionDetails") PromotionDetails promotionDetails, BindingResult result,
			ModelMap model) {
		promotionDetails.setSocietyId(society.getId());
		promotionDetails = promotionDetailsRepository.save(promotionDetails);
		promotionDetailsHistoryRepository
				.save(PromotionDetailsHistory.setUpObject(promotionDetails, userDetails.getLoginId()));
	...
	@Transactional(propagation = Propagation.REQUIRED, isolation = Isolation.READ_UNCOMMITTED)
	public ModelAndView deletePromotionDetails(@SessionAttribute("userDetails") UserDetails userDetails,
			@SessionAttribute("societyInfo") Society society, @ModelAttribute("id") Integer promotionDetailsId,
			BindingResult result, ModelMap model) {
		promotionDetailsHistoryRepository.save(PromotionDetailsHistory
				.setUpObject(promotionDetailsRepository.findById(promotionDetailsId).get(), userDetails.getLoginId()));
	...
	public ModelAndView getEditPromotionDetailsPage(@ModelAttribute("id") Integer promotionDetailsId,
			BindingResult result, ModelMap model) {
	...
	public ModelAndView getPromotionDetailsHistoryPage(@ModelAttribute("id") Integer promotionDetailsId) {
		Map<String, Object> model = new HashMap<>();
		List<PromotionDetailsHistory> promotionDetailsHistoryList = promotionDetailsHistoryRepository
				.findByPromotionDetailsIdOrderByUpdatedOnDesc(promotionDetailsId);
	...
	public ModelAndView getAddBonusDetailsPage(@ModelAttribute("bonusDetails") BonusDetails bonusDetails,
			BindingResult result, ModelMap model) {
	...
	@Transactional(propagation = Propagation.REQUIRED, isolation = Isolation.READ_UNCOMMITTED)
	public String saveBonusDetails(@SessionAttribute("userDetails") UserDetails userDetails,
			@SessionAttribute("societyInfo") Society society, @ModelAttribute("bonusDetails") BonusDetails bonusDetails,
			BindingResult result, ModelMap model) {
	...
	public ModelAndView getEditBonusDetailsPage(@ModelAttribute("id") Integer bonusDetailsId, BindingResult result,
			ModelMap model) {
	...
	@Transactional(propagation = Propagation.REQUIRED, isolation = Isolation.READ_UNCOMMITTED)
	public ModelAndView deleteBonusDetails(@SessionAttribute("userDetails") UserDetails userDetails,
			@SessionAttribute("societyInfo") Society society, @ModelAttribute("id") Integer bonusDetailsId,
			BindingResult result, ModelMap model) {
		bonusDetailsHistoryRepository.save(BonusDetailsHistory
				.setUpObject(bonusDetailsRepository.findById(bonusDetailsId).get(), userDetails.getLoginId()));
	...
	public ModelAndView getBonusDetailsHistoryPage(@ModelAttribute("id") Integer deputationId) {
		Map<String, Object> model = new HashMap<>();
		List<BonusDetailsHistory> bonusDetailsHistoryList = bonusDetailsHistoryRepository
				.findByBonusDetailsIdOrderByUpdatedOnDesc(deputationId);
	...
	public ModelAndView getAddStockVerificationPage(
			@ModelAttribute("stockVerification") StockVerification stockVerification, BindingResult result,
			ModelMap model) {
	...
	@Transactional(propagation = Propagation.REQUIRED, isolation = Isolation.READ_UNCOMMITTED)
	public String saveStockVerification(@SessionAttribute("userDetails") UserDetails userDetails,
			@SessionAttribute("societyInfo") Society society,
			@ModelAttribute("stockVerification") StockVerification stockVerification, BindingResult result,
			ModelMap model) {
		stockVerification.setSocietyId(society.getId());
		stockVerification = stockVerificationRepository.save(stockVerification);
		stockVerificationHistoryRepository
				.save(StockVerificationHistory.setUpObject(stockVerification, userDetails.getLoginId()));
	...
	public ModelAndView getEditStockVerificationPage(@ModelAttribute("id") Integer stockVerificationId,
			BindingResult result, ModelMap model) {
	...
	@Transactional(propagation = Propagation.REQUIRED, isolation = Isolation.READ_UNCOMMITTED)
	public ModelAndView deleteStockVerification(@SessionAttribute("userDetails") UserDetails userDetails,
			@SessionAttribute("societyInfo") Society society, @ModelAttribute("id") Integer stockVerificationId,
			BindingResult result, ModelMap model) {
		stockVerificationHistoryRepository.save(StockVerificationHistory.setUpObject(
				stockVerificationRepository.findById(stockVerificationId).get(), userDetails.getLoginId()));
	...
	public ModelAndView getStockVerificationHistoryPage(@ModelAttribute("id") Integer stockVerificationId) {
		Map<String, Object> model = new HashMap<>();
		List<StockVerificationHistory> stockVerificationHistoryList = stockVerificationHistoryRepository
				.findByStockVerificationIdOrderByUpdatedOnDesc(stockVerificationId);
	...
	public ModelAndView getAddDeputationPage(@ModelAttribute("deputation") Deputation deputation, BindingResult result,
			ModelMap model) {
	...
	@Transactional(propagation = Propagation.REQUIRED, isolation = Isolation.READ_UNCOMMITTED)
	public String saveDeputation(@SessionAttribute("userDetails") UserDetails userDetails,
			@SessionAttribute("societyInfo") Society society, @ModelAttribute("deputation") Deputation deputation,
			BindingResult result, ModelMap model) {
	...
	public ModelAndView getEditDeputationPage(@ModelAttribute("id") Integer deputationId, BindingResult result,
			ModelMap model) {
	...
	@Transactional(propagation = Propagation.REQUIRED, isolation = Isolation.READ_UNCOMMITTED)
	public ModelAndView deleteDeputation(@SessionAttribute("userDetails") UserDetails userDetails,
			@SessionAttribute("societyInfo") Society society, @ModelAttribute("id") Integer deputationId,
			BindingResult result, ModelMap model) {
		deputationHistoryRepository.save(DeputationHistory
				.setUpObject(deputationRepository.findById(deputationId).get(), userDetails.getLoginId()));
	...
	public ModelAndView getDeputationHistoryPage(@ModelAttribute("id") Integer deputationId) {
		Map<String, Object> model = new HashMap<>();
		List<DeputationHistory> deputationHistoryList = deputationHistoryRepository
				.findByDeputationIdOrderByUpdatedOnDesc(deputationId);
	...
	public ModelAndView getAddInspectionPage(@ModelAttribute("inspection") Inspection inspection, BindingResult result,
			ModelMap model) {
	...
	@Transactional(propagation = Propagation.REQUIRED, isolation = Isolation.READ_UNCOMMITTED)
	public String saveInspection(@SessionAttribute("userDetails") UserDetails userDetails,
			@SessionAttribute("societyInfo") Society society, @ModelAttribute("inspection") Inspection inspection,
			@RequestParam("file") MultipartFile[] files, BindingResult result, ModelMap model) {
	...
	@Transactional(propagation = Propagation.REQUIRED, isolation = Isolation.READ_UNCOMMITTED)
	public String updateInspection(@SessionAttribute("userDetails") UserDetails userDetails,
			@SessionAttribute("societyInfo") Society society, @ModelAttribute("inspection") Inspection inspection,
			BindingResult result, ModelMap model) {
	...
	public ModelAndView getEditInspectionPage(@ModelAttribute("id") Integer inspectionId, BindingResult result,
			ModelMap model) {
	...
	@Transactional(propagation = Propagation.REQUIRED, isolation = Isolation.READ_UNCOMMITTED)
	public ModelAndView deleteInspection(@SessionAttribute("userDetails") UserDetails userDetails,
			@SessionAttribute("societyInfo") Society society, @ModelAttribute("id") Integer inspectionId,
			BindingResult result, ModelMap model) {
		inspectionHistoryRepository.save(InspectionHistory
				.setUpObject(inspectionRepository.findById(inspectionId).get(), userDetails.getLoginId()));
	...
	public ModelAndView getInspectionHistoryPage(@ModelAttribute("id") Integer inspectionId) {
		Map<String, Object> model = new HashMap<>();
		List<InspectionHistory> inspectionHistoryList = inspectionHistoryRepository
				.findByInspectionIdOrderByUpdatedOnDesc(inspectionId);
	...
	public ModelAndView getAddPetitionPage(@ModelAttribute("petition") Petition petition, BindingResult result,
			ModelMap model) {
	...
	@Transactional(propagation = Propagation.REQUIRED, isolation = Isolation.READ_UNCOMMITTED)
	public String updatePetition(@SessionAttribute("userDetails") UserDetails userDetails,
			@SessionAttribute("societyInfo") Society society, @ModelAttribute("petition") Petition petition,
			BindingResult result, ModelMap model) {
	...
	@Transactional(propagation = Propagation.REQUIRED, isolation = Isolation.READ_UNCOMMITTED)
	public String savePetition(@SessionAttribute("userDetails") UserDetails userDetails,
			@SessionAttribute("societyInfo") Society society, @ModelAttribute("petition") Petition petition,
			@RequestParam("file") MultipartFile[] files, BindingResult result, ModelMap model) {
	...
	public ModelAndView getEditPetitionPage(@ModelAttribute("id") Integer petitionId, BindingResult result,
			ModelMap model) {
	...
	@Transactional(propagation = Propagation.REQUIRED, isolation = Isolation.READ_UNCOMMITTED)
	public ModelAndView deletePetition(@SessionAttribute("userDetails") UserDetails userDetails,
			@SessionAttribute("societyInfo") Society society, @ModelAttribute("id") Integer petetionId,
			BindingResult result, ModelMap model) {
		petitionHistoryRepository.save(
				PetitionHistory.setUpObject(petitionRepository.findById(petetionId).get(), userDetails.getLoginId()));
	...
	public ModelAndView getpetitionHistoryPage(@ModelAttribute("id") Integer petitionId) {
		Map<String, Object> model = new HashMap<>();
		List<PetitionHistory> petitionHistoryList = petitionHistoryRepository
				.findByPetitionIdOrderByUpdatedOnDesc(petitionId);
	...
	public ModelAndView getAddEnquiryPage(@ModelAttribute("enquiry") Enquiry enquiry, BindingResult result,
			ModelMap model) {
	...
	@Transactional(propagation = Propagation.REQUIRED, isolation = Isolation.READ_UNCOMMITTED)
	public String saveEnquiry(@SessionAttribute("userDetails") UserDetails userDetails,
			@SessionAttribute("societyInfo") Society society, @ModelAttribute("enquiry") Enquiry enquiry,
			@RequestParam("file") MultipartFile[] files, BindingResult result, ModelMap model) {
	...
	@Transactional(propagation = Propagation.REQUIRED, isolation = Isolation.READ_UNCOMMITTED)
	public String updateEnquiry(@SessionAttribute("userDetails") UserDetails userDetails,
			@SessionAttribute("societyInfo") Society society, @ModelAttribute("enquiry") Enquiry enquiry,
			BindingResult result, ModelMap model) {
	...
	public ModelAndView getEditEnquiryPage(@ModelAttribute("id") Integer enquiryId, BindingResult result,
			ModelMap model) {
	...
	@Transactional(propagation = Propagation.REQUIRED, isolation = Isolation.READ_UNCOMMITTED)
	public ModelAndView deleteEnquiry(@SessionAttribute("userDetails") UserDetails userDetails,
			@SessionAttribute("societyInfo") Society society, @ModelAttribute("id") Integer enquiryId,
			BindingResult result, ModelMap model) {
		enquiryHistoryRepository.save(
				EnquiryHistory.setUpObject(enquiryRepository.findById(enquiryId).get(), userDetails.getLoginId()));
	...
	public ModelAndView getEnquiryHistoryPage(@ModelAttribute("id") Integer enquiryId) {
		Map<String, Object> model = new HashMap<>();
		List<EnquiryHistory> enquiryHistoryList = enquiryHistoryRepository
				.findByEnquiryIdOrderByUpdatedOnDesc(enquiryId);
	...
	public ModelAndView getAddCourtCasePage(@ModelAttribute("courtcase") CourtCase courtCase, BindingResult result,
			ModelMap model) {
	...
	@Transactional(propagation = Propagation.REQUIRED, isolation = Isolation.READ_UNCOMMITTED)
	public String saveDeputation(@SessionAttribute("userDetails") UserDetails userDetails,
			@SessionAttribute("societyInfo") Society society, @ModelAttribute("courtcase") CourtCase courtCase,
			@RequestParam("file") MultipartFile[] files, BindingResult result, ModelMap model) {
...
//		documentRepository.deleteById(id);
	...
	@Transactional(propagation = Propagation.REQUIRED, isolation = Isolation.READ_UNCOMMITTED)
	public String deleteDocument(@SessionAttribute("userDetails") UserDetails userDetails,
			@SessionAttribute("societyInfo") Society society, @ModelAttribute("id") Integer documentId,
			@ModelAttribute("groupId") String groupId, @ModelAttribute("pageName") String pageName,
