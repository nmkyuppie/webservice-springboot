...
<nav class="navbar navbar-expand-lg navbar-light bg-light shadow">
	...
	<div class="collapse navbar-collapse" id="navbarColor03">
		<ul class="navbar-nav mr-auto">
         ...
         <li class="nav-item" style="margin-right: 15px;">
             <a class="nav-link underlineHover" href="/jewelloan/list#active"><i class="fa fa-money-bill-alt" aria-hidden="true"></i> Jewel Loan</a>
         </li>
         </ul> 
	</div>
	<% 
	...
	%>
	<a class="btn btn-bd-download d-none d-lg-inline-block mb-3 mb-md-0 ml-md-3" href="#"  style="font-size:14px;"><i class="fa fa-user" aria-hidden="true"></i>&nbsp; <%=userName %></a>
