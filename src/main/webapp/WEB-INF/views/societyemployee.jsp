...
<body>
    ...
    <div class="row justify-content-end" style="margin: 15px -15px;">
    	<div class="col offset-md-6">
    		<form action="/societyEmployee/add" method="GET">
				...
				<table class="table table-sm">
					...
					<tbody>
						<c:forEach items="${societyEmployeeList}" var="se">
							<tr>
								<td>
									<form action="/societyemployee/edit" method="POST">
								...
								<td>
									<form action="/societyemployee/history" method="POST">
										<input type="hidden" value="${se.id}" name="id">
								...
								<td>
									<form action="/societyemployee/delete" method="POST">
										<input type="hidden" value="${se.id}" name="id">
