                            ...
                            <fieldset>
                                ...
                                <div class="form-row">
	                                ...
	                                <div class="form-group col-sm-1">
	                                    <br>
	                                    <button type="button" class="btn btn-primary btn-action" id="areaCoverageButton" style="margin-top: 4px; height: 39px; width: 100%;"><i class="fa fa-plus" aria-hidden="true"></i> </button>
	                                </div>
                                ...
                                <div class="row">
	                                <div class="form-group col-lg-6">
	                                    <form:checkbox path="hasBranch"/> Has Branch?
	                                </div>
                                    <div class="col-lg-6">
