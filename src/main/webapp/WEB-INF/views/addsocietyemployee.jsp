...
<div class="row" style="padding:15px 0;">
	     <div class="col-lg-12" style="font-size:14px;">
	             <form:form method="POST" action="/societyEmployee/add" modelAttribute="societyEmployee">
	                 <fieldset>
                                ...
                                <div class="form-row">
	                                <div class="form-group col-sm-3">
	                                    ...
	                                    <form:input type="text" class="form-control"  name="emailId" path="emailId"/>
	                                </div>
	                                <div class="form-group col-sm-3">
	                                    <label>Cadre</label>
	                          ...
	                          <div class="row" style="padding:10px;">
		                         ...
		                         <div class="col-sm-9">
		                      		<button type="submit" class="btn btn-primary btn-action float-right" ><i class="fa fa-floppy-o" aria-hidden="true"></i> Save Employee</button>
