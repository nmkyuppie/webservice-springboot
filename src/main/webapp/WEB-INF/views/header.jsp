...
<nav class="navbar navbar-expand-lg navbar-light bg-light shadow">
	...
	<div class="collapse navbar-collapse" id="navbarColor03">
		<ul class="navbar-nav mr-auto">
         ...
         <li class="nav-item" style="margin-right: 15px;">
             <a class="nav-link underlineHover" href="/society/list"><i class="fa fa-university" aria-hidden="true"></i> Society</a>
         </li>
         <li class="nav-item" style="margin-right: 15px;">
             <a class="nav-link underlineHover" href="/jewelloan/list"><i class="fa fa-money" aria-hidden="true"></i> Jewel Loan</a>
         </li>
         </ul> 
	</div>
	<% 
